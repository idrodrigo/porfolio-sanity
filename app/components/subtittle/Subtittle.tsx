  ...
  return (
    <>
      <div className={`flex justify-center animate-wiggle animate-infinite animate-duration-[3500ms]`}>
        <h2
          className={`${marginTop} font-bold text-xl  before:block before:absolute before:-inset-1 before:-skew-y-3 group-hover/item:scale-75 before:bg-blue-500 relative inline-block`}
        >
