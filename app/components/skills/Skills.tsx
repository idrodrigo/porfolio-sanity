...
export default async function Skills() {
  ...
  return (
    <>
      ...
      <div className="mx-6 md:mx-8 lg:mx-12 mt-7 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-auto lg:gap-x-auto gap-y-8 my-10 border-b border-violet-500 pb-12">
